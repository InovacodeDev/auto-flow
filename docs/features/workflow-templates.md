...
# Sistema de Templates de Workflow (Consolidado)

O conteúdo completo foi consolidado. O resumo canônico e instruções estão em:

- ../consolidated/templates-and-setup.md

A versão completa e não editada está arquivada em:

- ../../archive/workflow-templates-full.md
...
- Cópia arquivada (conteúdo original completo): `../../archive/workflow-templates-full.md`

Para exemplos, DDL e trechos de código completos, abra a cópia arquivada.
